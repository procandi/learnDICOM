  ...
  module Logging
    ...
    module ClassMethods
      ...
      class ProxyLogger
        ...
        #
        # @example Inside the DICOM module or an external class with 'include WORKLIST::Logging':
        #   logger.info "message"
        #
      ...
      #
      # @example Inside the DICOM module (or a class with 'include WORKLIST::Logging'):
